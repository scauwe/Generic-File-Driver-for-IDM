...
public interface IFileStartStrategy extends ISubscriberStrategy{

    /**
     * Determines whether or not a new file is required prior to writing the given record.
     * This can be called multiple times for the same record.
     * @param trace
     * @param driverParams
